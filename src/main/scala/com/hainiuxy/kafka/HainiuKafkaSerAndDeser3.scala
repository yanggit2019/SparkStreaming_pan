...
// 定义Producer线程
class HainiuKafkaProducerSer3 extends Actor{
...
// 定义Consumer线程
class HainiuKafkaConsumerDeser3 extends Actor{
...
object HainiuKafkaSerAndDeser3{
  def main(args: Array[String]): Unit = {
    val topic:String = "hainiu_obj3"
    val producer = new HainiuKafkaProducerSer3(topic)
    val consumer = new HainiuKafkaConsumerDeser3(topic)
    consumer.start()
    producer.start()
  }
}
